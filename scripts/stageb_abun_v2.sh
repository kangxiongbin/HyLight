...
python $bin/build_abundance_between_contigs_v2.py -con contigs_b.fasta  -reads $2 -out sfoverlaps.out -p 0.90
...
python $bin/pipeline_per_stage.v3.py --no_error_correction --remove_branches true  --stage b --min_overlap_len 40 --min_overlap_perc 0 --edge_threshold 0.98 --overlaps sfoverlap.out.savage --fastq ./fastq --max_tip_len 1000 --num_threads 20
